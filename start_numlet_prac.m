function [accu, rec, status, exception] = start_numlet_prac(opts)
arguments
...
% ---- configure sequence ----
config = readtable(fullfile("config", "numlet_prac.xlsx"));
rec = config;
...
try
    ...
    introImg = imread(fullfile('intro_pic', 'NumLet.jpg'));
